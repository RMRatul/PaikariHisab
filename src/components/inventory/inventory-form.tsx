...
import { Package, Tag, Hash, Wallet, TrendingUp, CheckCircle2, ShieldAlert, ArrowLeft, Layers, Percent } from "lucide-react";
      ...
      <div className="flex flex-col md:grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-8 space-y-10">
              ...
              <div className="space-y-8">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                       <label htmlFor="code" className="text-[10px] font-black uppercase text-slate-400 tracking-widest pl-1">Product Code (কোড) *</label>
                       <div className="relative">
                          ...
                          <Input 
                            ...
                            className="h-14 rounded-2xl border-2 border-slate-50 bg-slate-50/50 pl-14 font-bold focus:border-emerald-500/50 focus:bg-white transition-all"
                          />
                       </div>
                    </div>
                    <div className="space-y-3">
                       <label htmlFor="category" className="text-[10px] font-black uppercase text-slate-400 tracking-widest pl-1">Category (ক্যাটাগরি) *</label>
                       <div className="relative">
                 ...
                 <div className="space-y-3">
                    <label htmlFor="name" className="text-[10px] font-black uppercase text-slate-400 tracking-widest pl-1">Product Name (পণ্যের নাম) *</label>
                    <Input 
                      id="name" 
                      name="name" 
                      required 
                      placeholder="e.g. Premium Cotton Embroidery Art" 
                      className="h-14 rounded-2xl border-2 border-slate-50 bg-slate-50/50 px-6 font-bold focus:border-emerald-500/50 focus:bg-white transition-all"
                    />
                 </div>
              </div>
           </div>
           ...
           <div className="bg-slate-900 text-white rounded-[3rem] p-10 relative overflow-hidden group shadow-2xl shadow-indigo-500/10">
              ...
              <p className="text-emerald-400 text-[10px] font-black uppercase tracking-[0.3em] mb-8">Pricing (দাম সেট করুন)</p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-4">
                  <label htmlFor="purchasePrice" className="text-[10px] font-black uppercase text-slate-500 tracking-widest pl-1">Buying Rate (ক্রয় মূল্য)</label>
                  <div className="relative">
                ...
                <div className="space-y-4">
                  <label htmlFor="sellingPrice" className="text-[10px] font-black uppercase text-slate-500 tracking-widest pl-1">Selling Rate (বিক্রয় মূল্য)</label>
                  <div className="relative">
        ...
        <div className="md:col-span-4 space-y-8">
           <Card className="border-none shadow-2xl shadow-slate-200/50 rounded-[3rem] overflow-hidden bg-white/80 backdrop-blur-xl border border-white/20">
             <CardHeader className="bg-slate-50/50 border-b border-slate-100/50 px-10 py-8 text-center">
                <CardTitle className="text-xl font-black font-outfit uppercase tracking-tighter text-slate-900">Profit Check (লাভ দেখুন)</CardTitle>
                <p className="text-slate-400 text-[9px] font-black uppercase tracking-widest">Real-time Margin Analysis</p>
             </CardHeader>
             <CardContent className="p-10 space-y-8">
                <div className="bg-slate-900 rounded-[2rem] p-8 space-y-2 text-center relative overflow-hidden group">
                   ...
                   <p className="text-[9px] font-black uppercase text-slate-500 tracking-[0.2em] relative z-10">Projected Margin</p>
                   <h4 className={cn(
                ...
                <div className="space-y-4">
                   <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest pl-1">Opening Stock (শুরুর স্টক)</p>
                   <div className="relative">
                      <Package className="absolute left-6 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-300 pointer-events-none" />
                      <Input 
                        id="stock" 
                        name="stock" 
                        type="number" 
                        ...
                        onFocus={(e) => e.target.select()}
                        placeholder="e.g. 100" 
                        className="h-14 rounded-2xl border-2 border-slate-50 bg-slate-50/50 pl-14 font-black transition-all"
                      />
                   </div>
                </div>
           ...
           <div className="bg-indigo-900 border border-indigo-800 rounded-[2rem] p-8 text-white relative overflow-hidden group shadow-2xl">
              ...
              <div className="flex gap-4 items-center">
                 ...
                 <div>
                    <p className="text-[10px] font-black uppercase tracking-widest opacity-70">Catalog Expansion</p>
                    <p className="text-xs font-bold font-outfit mt-0.5">Asset will be instantly available in Revenue Terminal.</p>
                 </div>
              </div>
           </div>
        </div>
